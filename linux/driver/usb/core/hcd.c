...
static const u8 ss_rh_config_descriptor[] = {			/* add 20091224 */
	/* one configuration */
	0x09,       /*  __u8  bLength; */
	0x02,       /*  __u8  bDescriptorType; Configuration */
	...
	case DeviceRequest | USB_REQ_GET_DESCRIPTOR:
		...
		case USB_DT_DEVICE << 8:
			...
			if (hcd->driver->flags & HCD_USB2)
				...
				goto error;
			#endif /* original 20100104 */
			
			switch (hcd->driver->flags & HCD_MASK){	/* add 20100104 */
			case HCD_USB3:
		...
		unsigned int irqnum, unsigned long irqflags)
{
	...
	switch (hcd->driver->flags & HCD_MASK) {		/* add 20091224 */
	case HCD_USB11:
